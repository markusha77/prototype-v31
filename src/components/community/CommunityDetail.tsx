...
import { Users, Briefcase, ArrowLeft, Share2, Bell, BellOff, MessageSquare, Calendar, Globe } from 'lucide-react'
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <Link to={`/community/${community.id}/members`} className="text-blue-600 hover:text-blue-800 text-sm">
                    View all
                  </Link>
                </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-xl font-bold text-gray-900">Community Projects</h2>
                  
                  <div className="flex space-x-4">
                    <select 
                      className="border border-gray-300 rounded-lg px-3 py-1.5 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <Link to={`/community/${community.id}/discussions`} className="text-blue-600 hover:text-blue-800 text-sm">
                    View all
                  </Link>
                </div>
